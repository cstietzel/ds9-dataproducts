...
## Get School Data
schools <- read_csv("../data/school_w_loc.csv")

## Get School Enrollment Data
enrollment <- read_csv("../data/enrollmentSingleYear14-15.csv", skip = 6, na = "*",
...
pupilspend <- read_csv("../data/perPupilExpeditures14-15.csv", skip = 5, na = "N/A", 
