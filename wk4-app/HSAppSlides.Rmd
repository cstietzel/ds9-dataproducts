...
- There is a great deal of interest in improving the performance of public education. This application attempts to use a simplistic model of using data published by the State of Connecticut to illustrate potential relationships between outcomes and input variables.
...
## CT High School Data
- Absenteeism and pupil spending was plotted to explore the data
...
## 2015 High School Performance App
...
- Links
    - <font size="4">HSApp shiny application</font>
    - <font size="4">Link to pitch book on Github:</font>
    - <font size="4">Code and RMD on Github:</font>
